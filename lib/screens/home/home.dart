      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Details(recipe),
            MyTitle(icon: FontAwesomeIcons.bookOpen, text: "INGREDIENTES"),
            ListElements(
            ...
            MyTitle(
                icon: FontAwesomeIcons.utensilSpoon, text: "MODO DE PREPARO"),
            ListElements(
                listOfElements: recipe.preparationModePaste, title: "Massa"),
            ListElements(
